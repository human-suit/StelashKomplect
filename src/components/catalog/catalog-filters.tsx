...
function Chip({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "touch-target shrink-0 whitespace-nowrap rounded-full px-3.5 py-2 text-sm font-medium transition-colors",
        active
    ...
    <div className="mt-4">
      <div className="flex items-center justify-between gap-2">
        <button
          ...
          className={cn(
            "touch-target flex flex-1 items-center justify-center gap-2 rounded-xl border px-4 py-2.5 text-sm font-semibold",
            activeCount > 0
